"""OpenCodeAdapter (Section 7.4 #3). Stub until Phase 12 -- fixed adapter order forbids
...
_NOT_IMPLEMENTED = "OpenCodeAdapter is implemented in Phase 12 (post-MVP additional adapters)."
