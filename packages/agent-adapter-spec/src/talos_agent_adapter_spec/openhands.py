"""OpenHandsAdapter (Section 7.4 #5). Stub until Phase 12+ -- fixed adapter order forbids
...
_NOT_IMPLEMENTED = "OpenHandsAdapter is implemented in Phase 12+ (post-MVP additional adapters)."
